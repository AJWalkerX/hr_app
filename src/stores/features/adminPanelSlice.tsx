...
const adminPanelSlice = createSlice({
  ...
  extraReducers:(build) =>{
    build.addCase(fetchListUserOnWait.pending,(state)=>{state.isOnWaitCustomerListLoading=true});
    build.addCase(fetchListUserOnWait.fulfilled,(state,action: PayloadAction<IBaseResponse>)=>{
    ...
    build.addCase(fetchCustomerList.pending,(state)=>{state.isCustomerListLoading=true});
    build.addCase(fetchCustomerList.fulfilled,(state,action: PayloadAction<IBaseResponse>)=>{
